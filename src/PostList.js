...
export const PostConfig = {
  ...
  //'3': { title: 'K Dimensional connect N - Part 2: Deep Learning', markdownSrcPromise: import('./posts/markdown/k-dimensional-connect-n-p1.md'), tags: ['Games', 'Policy Gradients', 'Deep Q Learning', 'Python', 'TensorFlow'], category: 'ML', date: 'Monday, 6th September 2017'},
